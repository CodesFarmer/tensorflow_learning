...
bs_data_dir = os.environ.get('BRAINSTORM_DATA_DIR', '/tmp/cifar10_data')
...
f.close()
print("Done.")
# x_tr = x_tr.reshape((nr_tr, 32, 32, 3)).transpose([0, 3, 1, 2])
# y_tr = y_tr.reshape((nr_tr, 1))
# f = h5py.File('/tmp/cifar10_data/cifar10_train_1.h5', 'w')
# f.create_dataset(name='data', data=x_tr[0:10000, :, :, :], dtype='float32')
# f.create_dataset(name='label', data=y_tr[0:10000, :], dtype='float32')
# f.close()
# f = h5py.File('/tmp/cifar10_data/cifar10_train_2.h5', 'w')
# f.create_dataset(name='data', data=x_tr[10001:20000, :, :, :], dtype='float32')
# f.create_dataset(name='label', data=y_tr[10001:20000, :], dtype='float32')
# f.close()
# f = h5py.File('/tmp/cifar10_data/cifar10_train_3.h5', 'w')
# f.create_dataset(name='data', data=x_tr[20001:30000, :, :, :], dtype='float32')
# f.create_dataset(name='label', data=y_tr[20001:30000, :], dtype='float32')
# f.close()
# f = h5py.File('/tmp/cifar10_data/cifar10_train_4.h5', 'w')
# f.create_dataset(name='data', data=x_tr[30001:40000, :, :, :], dtype='float32')
# f.create_dataset(name='label', data=y_tr[30001:40000, :], dtype='float32')
# f.close()
# f = h5py.File('/tmp/cifar10_data/cifar10_train_5.h5', 'w')
# f.create_dataset(name='data', data=x_tr[40001:50000, :, :, :], dtype='float32')
# f.create_dataset(name='label', data=y_tr[40001:50000, :], dtype='float32')
# f.close()
f = h5py.File('/tmp/cifar10_data/cifar10_test.h5', 'w')
nr_te = 10000
x_te = x_te.reshape((nr_te, 32, 32, 3)).transpose([0, 3, 1, 2])
y_te = y_te.reshape((nr_te, 1))
f.create_dataset(name='data', data=x_te, dtype='float32')
f.create_dataset(name='label', data=y_te, dtype='float32')
f.close()